...
root.lessons =
  1:
    0:
      startingText: "In Markdown zu schreiben ist nicht so schwer!"
      renderedAnswer: "<p>In Markdown zu schreiben ist <em>nicht</em> so schwer!</p>"
    1:
      startingText: "Ich werde diese Lektion schaffen!"
      renderedAnswer: "<p>Ich <strong>werde</strong> diese Lektion schaffen!</p>"
    2:
      startingText: "\"Oh natürlich,\" flüsterte Sie. Dann schrie Sie: \"Alles was Ich brauche, ist ein bisschen Mut!\""
      renderedAnswer: "<p>\"<em>Oh natürlich</em>,\" flüsterte Sie. Dann schrie Sie: \"Alles was Ich brauche, ist <strong>ein bisschen Mut</strong>!\"</p>"
    3:
      startingText: "Wenn du mal drüber nachdenkst, das ist unglaublich, du hast vermutlich recht."
      renderedAnswer: "<p>Wenn du mal drüber nachdenkst, <strong><em>das ist unglaublich</em></strong>, du hast vermutlich recht.</p>"
